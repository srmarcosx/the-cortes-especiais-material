	...
	<div
		...
		<header
			...
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title mdl-color-text--primary">Clientes</span>
		...
		<div class="mdl-grid demo-content">
			<!-- 			<div
				class="mdl-cell mdl-cell--1-col mdl-cell--hide-tablet mdl-cell--hide-phone"></div> -->
			<div
				...
				<table class="mdl-data-table mdl-js-data-table footable "
					...
					<thead>
						<tr>
							...
							<th class="numeric" data-hide="all">Telefone</th>
							<th>Estado</th>
							<th>Cidade</th>
							<th data-hide="all">Endereco</th>
						...
						<c:forEach items="${clienteList}" var="cliente">
							<c:if test="${cliente.ativo}">
								<tr>
									...
									<td data-type="numeric" data-sort-initial="true">${cliente.idCliente}</td>
									<td>${cliente.nome}</td>
									<td class="numeric">${cliente.cpf}</td>
									<td class="numeric">${cliente.telefone}</td>
									...
									<td class="numeric"><a
										...
										href="
										${linkTo[ClienteController].ativo}?idCliente=${cliente.idCliente
										}"
										onclick="return confirm('Você tem certeza que deseja excluir?');"><i
											class="material-icons icon-delete"></i> </a><a
										class="mdl-button mdl-button--icon mdl-button--colored table-button"
										href="${linkTo[ClienteController].edit}?idCliente=${cliente.idCliente}"><i
			...
			<a
				...
				id="float-button" href="${linkTo[ClienteController].add}"><i
