	...
	<div id="layout">
		...
		<div id="content">
			...
			<form class="form-horizontal"
				...
				<input type="hidden" name="itemEstoque.idItem"
						value="${itemEstoque.idItem}" />
				<div class="form-group">
					<div class="col-md-8">
						<label for="nomeProduto">Produto</label> <input
							class="form-control" id="nomeProduto"
							name="itemEstoque.nome" value="${itemEstoque.nome}">
					</div>
					<div class="col-md-4">
						<label for="quantidade">Quantidade</label> <input
							class="form-control" id="quantidade"
							name="itemEstoque.quantidade" value="${itemEstoque.quantidade}"/>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-12">
