	...
	function Paginate() {
		...
		p.createNavigation = function (ft, tbody) {
			...
			if (info.pages.length > 0) {
				$nav.append('<li class="footable-page-arrow"><a class="mdl-button mdl-button--icon table-button" data-page="prev" href="#prev"><i class="material-icons icon-keyboard_arrow_left"></i></a></li>');
				if (info.limit){
				...
				if (!info.limit){
					$.each(info.pages, function (i, page) {
						if (page.length > 0) {
							$nav.append('<li class="footable-page"><a class="mdl-button mdl-button--icon table-button" data-page="' + i + '" href="#">' + (i + 1) + '</a></li>');
						}
					});
				}
				if (info.limit){
				...
				$nav.append('<li class="footable-page-arrow"><a class="mdl-button mdl-button--icon table-button" data-page="next" href="#next"><i class="material-icons icon-keyboard_arrow_right"></i></a></li>');
			}
