			...
			<form class="form-horizontal"
				...
				<div class="form-group">
					...
					<label for="nome">Nome</label> 
						<input class="form-control" id="nome" name="funcionario.nome"
							placeholder="Nome" />
					</div>
				</div>
				<div class="form-group">
					...
					<label for="cpf">CPF/CNPJ</label>
						<input class="form-control" id="cpf" name="funcionario.cpf"
							placeholder="CPF/CNPJ" />
					</div>
					<div class="col-md-5">
					<label for="telefone">Telefone</label>
						<input class="form-control" id="telefone" name="funcionario.telefone"
				...
				<div class="form-group">
					...
					<label for="endereco">Endereço</label>
						<input class="form-control" id="endereco" name="funcionario.endereco"
