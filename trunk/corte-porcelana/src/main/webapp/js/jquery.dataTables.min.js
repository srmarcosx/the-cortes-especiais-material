...
b}function nb(a){var b=a.oClasses,c=a.sTableId,e=a.oLanguage,d=a.oPreviousSearch,f=a.aanFeatures,h='<div class="input-group"><input id="search" type="search" class="'+b.sFilterInput+'"/><span class="input-group-addon" id="search"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></span></div>',i=e.sSearch,i=i.match(/_INPUT_/)?i.replace("_INPUT_",h):i+h,b=g("<div/>",{id:!f.f?c+"_filter":null,"class":b.sFilter}).append(g("<label/>").append(i)),f=function(){var b=!this.value?"":this.value;b!=d.sSearch&&(fa(a,{sSearch:b,bRegex:d.bRegex,bSmart:d.bSmart,bCaseInsensitive:d.bCaseInsensitive}),a._iDisplayStart=0,L(a))},h=null!==a.searchDelay?a.searchDelay:
...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:'<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>',sLast:'<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>',sNext:'<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>',sPrevious:'<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>'},sEmptyTable:"Nenhum dado disponivel na tabela",sInfo:"Exibindo _START_ - _END_ de _TOTAL_ itens",sInfoEmpty:"Exibindo 0 - 0 de 0 itens",sInfoFiltered:"(filtrados de _MAX_ itens)",sInfoPostFix:"",sDecimal:"",
